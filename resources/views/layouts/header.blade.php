                ...
                <div>
                    <ul class="nav nav-tabs" role="tablist" style="border-width: 1px;">
                        <li class="nav-item text-center" role="presentation"
                            style="width: 120px;background: #e6ebf1;"><a class="nav-link" role="tab"
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active text-center"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" role="tabpanel" id="tab-1"
                            ...
                            <div class="d-xl-flex justify-content-xl-center" id="myModal"
                                style="margin: 0px;padding-bottom: 331px;border-width: 0px;background: #f4f9f9;height: 303px;">
                                <div class="d-xl-flex justify-content-xl-center modal-dialog modal-login"
                                    ...
                                    <div class="modal-content"
                                        ...
                                        <div class="modal-body"
                                            ...
                                            <form action="confirmation" method="post">
                                                <div class="form-group"><i class="fa fa-star fa-user"></i><input
                                                        ...
                                                        required="required" style="margin: 0px;margin-bottom: 8px;"
                                                ...
                                                <div class="text-start"
                                                    style="padding-top: 14px; margin-bottom: -14px"><input
                                        ...
                                        <div class="d-xl-flex justify-content-xl-center modal-footer"
                                            ...
                                            <!-- Start: Register --><a style="margin: 0px;color: rgb(153,153,153);"
                                                href="index.html" data-bs-target="#modal-2"
                                                data-bs-toggle="modal">Dont have any acount? Sign up</a>
                                            <!-- End: Register -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-xl-flex justify-content-xl-center" id="myModal-1"
                                ...
                                <div class="d-xl-flex justify-content-xl-center modal-dialog modal-login"
                                    ...
                                    <div class="modal-content" style="padding: 0px;background: #fef9f9;">
                                        ...
                                        <div class="text-start"
                                            style="background: #fef9f9;width: 368px;margin-left: 16px;"><input
                                                type="checkbox" name="Remember me">
                ...
                <div style="margin-bottom: 0px;margin-top: 0px;">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active" role="tab"
                                ...
                                style="color: var(--bs-nav-tabs-link-active-color);background: #fef9f9;border-bottom-color: #fef9f9;">Vendor</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                                ...
                                <div class="d-xl-flex justify-content-xl-center modal-dialog modal-login"
                                    ...
                                    <div class="modal-content" style="padding: 0px;background: #fef9f9;">
                                        <div class="modal-body"
                                            style="padding: 16px;padding-bottom: 0px;background: #fef9f9;">
                                            <form action="confirmation" method="post">
                                                <div class="form-group"><i class="fa fa-building-o fa-user"></i><input
                                                        class="form-control" type="text" placeholder="Nama Toko"
                                                        required="required" style="margin: 0px;margin-bottom: 8px;"
                                                        name="NAME_SHOP"></div>
                                                <div class="form-group"><i
                                                        class="fa fa-envelope-square fa-user"></i><input
                                                ...
                                                <div class="form-group"><i class="fa fa-building-o fa-user"></i><input
                                                        class="form-control" type="text" placeholder="Alamat"
                                                        required="required" style="margin: 0px;margin-bottom: 8px;"
                                                        name="ADDRESS_SHOP"></div>
                                                <div class="form-group"><i class="fa fa-building-o fa-user"></i><input
                                                        class="form-control" type="text" placeholder="Postal Code"
                                                        required="required" style="margin: 0px;margin-bottom: 8px;"
                                                        name="POSTAL_SHOP"></div>
                                                <div class="form-group"><i class="fa fa-star fa-lock"></i><input
                                                        class="form-control" type="password" placeholder="Password"
                                                        required="required"
                                                        style="margin-bottom: 6px;margin-top: 8px;"></div>
                                                <div class="d-xl-flex justify-content-xl-start form-group"
                                                    style="margin-right: 0px;margin-left: 20px;"><button
                                                        class="btn btn-primary btn-block btn-lg" type="submit"
                                                        value="Login"
                                                        style="margin-top: 6px;margin-bottom: 12px;">Register</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
