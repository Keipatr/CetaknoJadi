        ...
        <div class="col-md-6">
          <div class="slider slider-for">
            <div>
              ...
              <!-- img -->
              <!-- img --><img src="images/products/product-single-img-1.jpg" alt="">
            </div>
            </div>
            <div>
              <div class="zoom" onmousemove="zoom(event)"
              ...
              <!-- img -->
              <!-- img --><img src="images/products/product-single-img-2.jpg" alt="">
            </div>
            </div>
            <div>
              <div class="zoom" onmousemove="zoom(event)"
              ...
              <!-- img -->
              <!-- img --><img src="images/products/product-single-img-3.jpg" alt="">
            </div>
            </div>
            <div>
              <div class="zoom" onmousemove="zoom(event)"
            ...
            <div>
              ...
              <!-- img -->
              <!-- img --><img src="images/products/product-single-img-4.jpg" alt="">
            </div>
            </div>
          </div>
                        ...
                        <div class="ms-5">
                          ...
                          <div>
                            <div class="border icon-shape icon-lg border-2 ">
                              <!-- img --><img src="images/products/product-img-1.jpg" alt=""
                                class="img-fluid ">
                            </div>
                            <div class="border icon-shape icon-lg border-2 ms-1 ">
                              <!-- img --><img src="images/products/product-img-2.jpg" alt=""
                                class="img-fluid ">
                            </div>
                            <div class="border icon-shape icon-lg border-2 ms-1 ">
                              <!-- img --><img src="images/products/product-img-3.jpg" alt=""
                                class="img-fluid ">
                            </div>
          ...
          <div class="card card-product">
            <div class="card-body">
              ...
              <div class="text-center position-relative ">
                ...
                <a href="#!">
                  <!-- img --><img src="images/products/product-img-1.jpg" alt="Grocery Ecommerce Template"
