                    ...
                    <div class="col-12 ">
                        ...
                        <div class="bg-light d-flex justify-content-between ps-md-10 ps-6 rounded">
                            ...
                            <div class="py-6">
                                <!-- img -->
                                <!-- img -->
                                <img src="images/svg-graphics/store-graphics.svg" alt="" class="img-fluid">
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-4">
                            <!-- title -->
                            <h6>We have <span class="text-primary">9</span> vendors now</h6>
                        </div>
                    </div>
                </div>
                <!-- row -->
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">D'Raya Jember</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Organic</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                                            height="4" fill="#C1C7C6" class="bi bi-circle-fill align-middle "
                                            viewBox="0 0 16 16">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Kosko Printing</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Alcohol</span> <span class="mx-1"><svg
                                ...
                                <div>
                                    <!-- badge -->
                                    <div class="badge text-bg-light border">7.2 km away</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Aneka Niaga</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Groceries</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                                            height="4" fill="#C1C7C6" class="bi bi-circle-fill align-middle "
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Digital Printing</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Meal Kits</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                                            height="4" fill="#C1C7C6" class="bi bi-circle-fill align-middle "
                                ...
                                <div>
                                    <!-- badge -->
                                    <div class="badge text-bg-light border">4.5 km away</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Wiyung Printing</a>
                                </h5>
                                <div class="small text-muted">
                                    {{-- <span>Groceries</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Spectrum</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Groceries</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                                            height="4" fill="#C1C7C6" class="bi bi-circle-fill align-middle "
                                ...
                                <div>
                                    <!-- badge -->
                                    <div class="badge text-bg-light border">5.5 km away</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Swiggy Printing</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Meal Kits</span>
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="#!" class="text-inherit">Online Printing</a></h5>
                                <div class="small text-muted">
                                    {{-- <span>Groceries</span>
                                    <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4"
                                            height="4" fill="#C1C7C6" class="bi bi-circle-fill align-middle "
                                ...
                                <div>
                                    <!-- badge -->
                                    <div class="badge text-bg-light border">8.1 km away</div>
                                </div>
                            </div>
                        </div>
                    </div>
