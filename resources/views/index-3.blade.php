  ...
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-start p-4 w-xxl-20 w-lg-30" id="navbar-default">
      <div class="d-flex justify-content-between align-items-center mb-2 ">
        <a href="../index.html"><img src="images/logo/freshcart-logo.svg" alt="eCommerce HTML Template"></a>
...
<li><a class="dropdown-item" href="../pages/shop-single-2.html">Shop Single v2<span class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
        ...
        <li class="nav-item dropdown dropdown-flyout">
          ...
          <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item align-items-start"
      ...
      <div class="row">
        <div class="col-xxl-8 col-xl-7 ">
          ...
          <div class="hero-slider">
            <div
              style="background: url(images/slider/slider-image-1.jpg)no-repeat; background-size: cover; border-radius: .5rem;">
             ...
             <!-- img -->
            <div class=" "
              style="background: url(images/slider/slider-image-2.jpg)no-repeat; background-size: cover; border-radius: .5rem;">
       ...
       <!-- title -->
                ...
                <a href="#!" class="btn btn-primary">Shop Deals Now<i
                   ...
                   <!-- img -->
            <div class=" "
              style="background: url(images/slider/slider-image-3.jpg)no-repeat; background-size: cover; border-radius: .5rem;">
              <div class="ps-lg-12 py-lg-16 col-xxl-7 col-lg-9 py-14 ps-8 text-xs-center">
                       <!-- badge -->
                <div class="d-flex align-items-center mb-4"><span>Exclusive Offer</span> <span
       ...
       <!-- title -->
        ...
        <div class="col-xxl-4 col-xl-5 col-12 d-lg-flex d-xl-block gap-3 gap-xl-0">
          ...
          <div class="flex-fill px-8 py-9 mb-6 mb-md-0 mb-xl-6 rounded" style="background:url(images/banner/ad-banner-1.jpg)no-repeat; background-size: cover;">
            <div>
          ...
          <div class="flex-fill px-8 py-8 rounded " style="background:url(images/banner/ad-banner-2.jpg)no-repeat; background-size: cover;">
...
<div>
 ...
 <!-- img -->
              <a href="#"><img src="images/category/dairy-bread-eggs.png" alt=""
 ...
 <!-- text -->
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
 <!-- img -->
              <a href="#"><img src="images/category/fruits-vegetables.png" alt=""
                  class="card-image rounded-circle"></a>
              <div class="mt-4">
                 <!-- text -->
          ...
          <div class="col-lg-2 col-md-4 col-6">
            ...
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/snack-munchies.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
 <!-- img -->
              <a href="#"><img src="images/category/bakery-biscuits.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/instant-food.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/tea-coffee-drinks.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/cold-drinks-juices.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/chicken-meat-fish.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            ...
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/baby-care.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
               <!-- img -->
              <a href="#"><img src="images/category/cleaning-essentials.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- img -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="text-center mb-10">
 <!-- img -->
              <a href="#"><img src="images/category/pet-care.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            ...
            <div class="text-center mb-10">
 <!-- img -->
              <a href="#"><img src="images/category/atta-rice-dal.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="mb-4 bg-light d-lg-flex justify-content-between align-items-center rounded">
            ...
            <div class="p-6 d-lg-block d-none"><img src="images/svg-graphics/store-graphics.svg" alt=""
                class="img-fluid">
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-md-flex justify-content-between align-items-center mb-8">
            <div>
              <h3 class=" mb-1">Special Offers of the View All Week!</h3>
              <p>Get exclusive ongoing offers, deals, and discount codes of shopping</p>
            </div>
            <div>
              <a href="#">View All <i class="feather-icon icon-chevron-right"></i></a>
            </div>
          </div>

        </div>
      </div>
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-0 border border-2 border-danger">
          ...
          <div class="card  card-product-v2 h-100">
            <div class="card-body position-relative text-center">
              ...
              <div class="text-center position-relative ">
                ...
                <!-- img -->
                <a href="#!"> <img src="images/products/product-img-3.jpg" alt="Grocery Ecommerce Template"
                    class="mb-3 img-fluid"></a>
                <!-- action btn -->
                    <div class="product-action-btn">
                  <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
          ...
          <div class="card  card-product-v2 h-100">
            <div class="card-body position-relative text-center">
              ...
              <div class="text-center position-relative ">
                ...
                <!-- img -->
                <a href="#!"> <img src="images/products/product-img-8.jpg" alt="Grocery Ecommerce Template"
                    class="mb-3 img-fluid"></a>
                <!-- action btn -->
                    <div class="product-action-btn">
                  <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
          ...
          <div class="card  card-product-v2 h-100">
            <div class="card-body position-relative text-center">
              ...
              <div class="text-center position-relative ">
                ...
                <!-- img -->
                <a href="#!"> <img src="images/products/product-img-9.jpg" alt="Grocery Ecommerce Template"
                    class="mb-3 img-fluid"></a>
                <!-- action btn -->
                    <div class="product-action-btn">
                  <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
          ...
          <div class="card  card-product-v2 h-100">
            <div class="card-body position-relative text-center">
              ...
              <div class="text-center position-relative ">
                ...
                <!-- img -->
                <a href="#!"> <img src="images/products/product-img-10.jpg" alt="Grocery Ecommerce Template"
                    class="mb-3 img-fluid"></a>
                <!-- action btn -->
                    <div class="product-action-btn">
                  <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
          ...
          <div class="card  card-product h-100">
            <div class="card-body position-relative">
              ...
              <div class="text-center position-relative ">
                ...
                <!-- img -->
                <a href="#!"> <img src="images/products/product-img-5.jpg" alt="Grocery Ecommerce Template"
                    class="mb-3 img-fluid"></a>
                <!-- action btn -->
                    <div class="product-action-btn">
                  <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
 ...
 <!-- rating -->
  ...
  <section class="bg-dark"
    style="background:url(images/svg-graphics/pattern.svg)no-repeat; background-size: cover; background-position: center;">
    <div class="container">
       <!-- row -->
      <div class="row">
