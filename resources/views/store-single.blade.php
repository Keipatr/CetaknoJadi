      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="d-flex flex-column">
              ...
              <div class="mt-4">
                ...
                <div>
                  <span
                    ><small
                      ><a href="#!">100% satisfaction guarantee</a></small
                    ></span
                  >
                </div>
                <!-- rating -->
                <div class="mt-2">
                  ...
                  <!-- text --><span class="text-muted ms-1"
                    >(3,400 reviews)</span
                  >
                </div>
              </div>
            ...
            <ul class="nav flex-column nav-pills nav-pills-dark">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#"
                  ><i class="feather-icon icon-shopping-bag me-2"></i>Shop</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-gift me-2"></i>Deals</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-map-pin me-2"></i>Buy It Again</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-star me-2"></i>Reviews</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-book me-2"></i>Recipes</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-phone-call me-2"></i>Contact</a
                >
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="feather-icon icon-clipboard me-2"></i>Policy</a
                >
              </li>
            </ul>
            <hr />
          ...
          <div class="col-12 col-lg-9 col-md-8">
            <div
              class="mb-8 bg-light d-lg-flex justify-content-lg-between rounded"
            >
                ...
                <div class="card card-product">
                  <div class="card-body">
                    ...
                    <div>
                      ...
                      ></small>
                      <!-- text --><span class="text-muted small"
                        >4.5(149)</span
                      >
                    </div>
                    <!-- price -->
              ...
              <div class="col">
                ...
                <nav>
                  <ul class="pagination">
                    ...
                    <li class="page-item">
                      <a class="page-link mx-1 text-body" href="#"
                        >2</a
                      >
                    </li>
                    ...
                    <li class="page-item">
                      <a
                        class="page-link mx-1 text-body"
                        href="#"
                        aria-label="Next"
                      >
