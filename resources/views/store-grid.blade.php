 ...
 <!-- col -->
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-1.svg" alt=""
        ...
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-2.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
               <!-- content --><h2 class="mb-1 h5"><a href="#!" class="text-inherit">DealShare Mart</a></h2>
                ...
                <div>
                  <!-- badge --> <div class="badge text-bg-light border">7.2 mi away</div>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-3.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
               <!-- content --><h2 class="mb-1 h5"><a href="#!" class="text-inherit">DMart</a></h2>
                ...
                <div>
                  <!-- badge --> <div class="badge text-bg-light border">9.3 mi away</div>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-4.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
               <!-- content --><h2 class="mb-1 h5"><a href="#!" class="text-inherit">Blinkit Store</a></h2>
                ...
                <div>
                  <!-- badge --> <div class="badge text-bg-light border">40.5 mi away</div>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-5.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
               <!-- content --><h2 class="mb-1 h5"><a href="#!" class="text-inherit">StoreFront Super Market</a></h2>
                ...
                <div>
                  <!-- badge --> <div class="badge text-bg-light border">28.1 mi away</div>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-6.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
        ...
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-7.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
        ...
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-8.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
        ...
        <div class="col">
           <!-- card --><div class="card p-6 card-product">
            <div> <!-- img --><img src="images/stores-logo/stores-logo-9.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <div class="mt-4">
