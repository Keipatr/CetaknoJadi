                  ...
                  <div class=" row align-items-center">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div class=" mt-6">
                        ...
                        <!-- btn -->
                        <div class="mt-2"><a href="#!" class="btn btn-primary ">
                ...
                <div class="card-body">
                  <div class=" row align-items-center">
                    <div class="col-md-4 col-12">
                      ...
                      <div class="text-center position-relative">
                        <div class=" position-absolute top-0">
                          <!-- badge --> <span class="badge bg-success">14%</span>
                        </div>
                        <a href="shop-single.html">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Bakery &
                            Biscuits</small></a></div>
                      <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Cadbury 5 Star
                          Chocolate</a></h2>
                      <div>
                        ...
                        <!-- rating --><small class="text-warning"> <i class="bi bi-star-fill"></i>
                          ...
                          <i class="bi bi-star-fill"></i>
                          <i class="bi bi-star-fill"></i>
                          <i class="bi bi-star-fill"></i></small> <span class="text-muted small">5(69)</span>
                      </div>
                      <div class=" mt-6">
                        <!-- price -->
                        <div><span class="text-dark">$14</span>
                        </div>
                        <!-- btn -->
                        <div class="mt-3">
                          <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted"
                ...
                <div class="card-body">
                  <div class=" row align-items-center">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Snack &
                            Munchies</small></a></div>
                      <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">Onion Flavour Potato</a>
                      </h2>
                      <div>
                      ...
                      <div class=" mt-6">
                        ...
                        <div><span class="text-dark">$3</span> <span
                            class="text-decoration-line-through text-muted">$9</span>
                        </div>
                        <!-- btn -->
                        <div class="mt-3">
                          <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted"
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div>
                        ...
                        <!-- rating --><small class="text-warning"> <i class="bi bi-star-fill"></i>
                          ...
                          <i class="bi bi-star-fill"></i>
                          <i class="bi bi-star-fill"></i>
                          <i class="bi bi-star"></i></small> <span class="text-muted small">4.5(456)</span>
                      </div>
                      <div class=" mt-6">
                        <!-- price -->
                        <div><span class="text-dark">$13</span> <span
                            class="text-decoration-line-through text-muted">$19</span>
                        </div>
                        <!-- btn -->
                        <div class="mt-3">
                          <a href="#!" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted"
